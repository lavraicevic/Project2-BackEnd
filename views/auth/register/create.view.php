    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        ...
        <form class="w-full max-w-md"  action="/register" method="POST">
            ...
            <div class="flex items-center justify-center mt-6">
                ...
                <a href="#" class="w-1/3 pb-4 font-medium text-center text-gray-800 text-2xl capitalize ">
                    sign up
                </a>
            </div>
            ...
            <label for="dropzone-file" class="flex items-center px-3 py-3 mx-auto mt-6 text-center bg-white border-2 border-dashed rounded-lg cursor-pointer dark:border-gray-600 dark:bg-gray-900">
                ...
                <input id="dropzone-file" type="file" class="hidden" name="profile-photo" id="profile-photo" />
            </label>
